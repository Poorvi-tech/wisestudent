...
const LEFT_ITEMS = [
  { id: "name-choice", text: "Decide a unique Business Name" },
  { id: "registration", text: "Register with local authority / MSME" },
  { id: "bank-account", text: "Open a Business Bank Account" },
  { id: "tax-enrollment", text: "Enroll for GST / Tax ID" },
  { id: "open-shop", text: "Launch Operations & Open Shop" },
];

const RIGHT_ITEMS = [
  { id: "step-5", text: "Step 5 — Go Live" },
  { id: "step-1", text: "Step 1 — Identity & Branding" },
  { id: "step-4", text: "Step 4 — Tax Compliance Setup" },
  { id: "step-2", text: "Step 2 — Legal Recognition" },
  { id: "step-3", text: "Step 3 — Financial Infrastructure" },
];
...
const SOLUTIONS = {
  ...
  "registration": "step-2",
  "bank-account": "step-3",
  "tax-enrollment": "step-4",
  "open-shop": "step-5",
};

const PuzzleRegistrationSteps = () => {
  ...
  // Registering at index 62
  const gameId = "finance-business-livelihood-finance-62";
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText("Wrong order! Think about what must happen before you can do this step.");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Puzzle complete! You know exactly how to formally register a business."
          : `Arrange the steps: ${score}/${totalPairs} matched`
      }
...
export default PuzzleRegistrationSteps;
