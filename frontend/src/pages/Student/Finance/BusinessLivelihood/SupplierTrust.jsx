...
const SUPPLIER_TRUST_STAGES = [
  {
    id: 1,
    prompt: "Supplier prefers businesses that keep records. Why?",
    options: [
      {
        id: "decoration",
        text: "Decoration",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        outcome: "Contracts and records work together.",
        isCorrect: false,
      },
      {
        id: "clear-payments",
  ...
  {
    id: 3,
    prompt: "What risk happens without payment records?",
    options: [
      {
        id: "disputes",
        text: "Disputes about payments",
        outcome: "Correct. Missing proof leads to conflicts.",
        isCorrect: true,
      },
      {
        id: "more-profit",
  ...
  {
    id: 5,
    prompt: "What is the key takeaway about supplier trust?",
    options: [
      {
        id: "systems",
        text: "Professional systems build partnerships",
        outcome: "Correct. Records strengthen supplier trust.",
        isCorrect: true,
      },
      {
        id: "optional",
        text: "Records are optional",
        outcome: "Records are essential for long-term trust.",
        isCorrect: false,
      },
      {
        id: "trust-only",
...
const SupplierTrust = () => {
  ...
  const stage = SUPPLIER_TRUST_STAGES[currentStageIndex];
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Quiz complete! You now know how professional systems build partnerships."
