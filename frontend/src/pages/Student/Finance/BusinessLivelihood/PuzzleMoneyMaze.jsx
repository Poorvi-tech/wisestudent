...
const LEFT_ITEMS = [
  { id: "business-profit", text: "Business Profit / Revenue" },
  { id: "personal-expense", text: "Personal / Home Expense" },
  { id: "supplier-payment", text: "Supplier Invoice Payment" },
  { id: "emergency-fund", text: "Emergency Business Reserve" },
  { id: "equipment-loan", text: "Asset / Equipment Loan" },
];

const RIGHT_ITEMS = [
  { id: "personal-savings", text: "Personal Savings Account" },
  { id: "liability-ledger", text: "Business Liability / Debt" },
  { id: "liquid-savings", text: "High-Yield Reserve Account" },
  { id: "operating-expense", text: "Operating Expense Ledger" },
  { id: "business-bank", text: "Business Current Account" },
];

const SOLUTIONS = {
  "business-profit": "business-bank",
  "personal-expense": "personal-savings",
  "supplier-payment": "operating-expense",
  "emergency-fund": "liquid-savings",
  "equipment-loan": "liability-ledger",
};

const PuzzleMoneyMaze = () => {
  ...
  const handleRightSelect = (r) => {
    ...
    if (r.id === correctRight) {
      ...
      setOutcomeText(`Routed successfully: ${selectedLeft.text} → ${r.text}`);
      const doneCount = Object.keys(matched).length + 1;
      if (doneCount === totalPairs) {
        setShowResult(true);
      }
    } else {
      setOutcomeText("Routing Error: That money does not belong there!");
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Maze solved! Perfect separation of business and personal finances."
          : `Route the funds correctly: ${score}/${totalPairs} matched`
      }
...
export default PuzzleMoneyMaze;
