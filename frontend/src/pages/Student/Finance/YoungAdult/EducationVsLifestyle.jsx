...
const EDUCATION_LIFESTYLE_STAGES = [
  {
    id: 1,
...
const totalStages = EDUCATION_LIFESTYLE_STAGES.length;
...
const EducationVsLifestyle = () => {
  ...
  const handleChoice = (option) => {
    ...
    resetFeedback();
    const currentStageData = EDUCATION_LIFESTYLE_STAGES[currentStage];
  ...
  const stage = EDUCATION_LIFESTYLE_STAGES[Math.min(currentStage, totalStages - 1)];
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}
      maxScore={EDUCATION_LIFESTYLE_STAGES.length}
      currentLevel={Math.min(currentStage + 1, EDUCATION_LIFESTYLE_STAGES.length)}
      totalLevels={EDUCATION_LIFESTYLE_STAGES.length}
      gameId={gameId}
      gameType="finance"
              ...
              {showResult && (
                <>
                  ...
                  <p className="text-sm text-white/70">
                    Skill unlocked: <strong>Educational investment strategy</strong>
                  </p>
                  {!hasPassed && (
