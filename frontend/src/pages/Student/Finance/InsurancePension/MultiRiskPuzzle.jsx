...
const PAIRS = [
  { left: "Health Risk", right: "Health Insurance", id: "health" },
  { left: "Old-Age Income Risk", right: "Pension", id: "old-age" },
  { left: "Accident Risk", right: "Personal Accident Cover", id: "accident" },
  { left: "Job Loss Risk", right: "Emergency Fund", id: "job-loss" },
  { left: "Property Damage Risk", right: "Property Insurance", id: "property" },
];
...
const MultiRiskPuzzle = () => {
  ...
  const gameId = "finance-insurance-pension-46";
...
export default MultiRiskPuzzle;