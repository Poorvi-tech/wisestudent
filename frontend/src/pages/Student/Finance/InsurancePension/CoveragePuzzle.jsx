...
const PAIRS = [
  { left: "Hospitalization", right: "Health Cover", id: "hospitalization" },
  { left: "Death", right: "Life Cover", id: "death" },
  { left: "Fire", right: "Property Cover", id: "fire" },
  { left: "Third-Party Damage", right: "Motor Cover", id: "third-party" },
  { left: "Critical Illness", right: "Critical Illness Cover", id: "critical-illness" },
];
...
const CoveragePuzzle = () => {
  ...
  const handleSelectRight = (item) => {
    ...
    if (correct) {
      ...
      if (currentStageIndex === totalStages - 1) {
        ...
        setTimeout(() => setCurrentStageIndex((prev) => prev + 1), 400);
      }
    }
  ...
  return (
    <GameShell
      ...
      subtitle={
        showResult
          ? "Puzzle complete! Coverages matched to events."
          : `Match ${progressLabel}: Link event to coverage`
      }
        ...
        {showResult && (
          <div className="space-y-4">
            <div className="rounded-2xl bg-white/10 border border-white/20 p-4 text-sm text-white/80">
              Great job! You correctly matched insurance cover types to real-life events.
            </div>
